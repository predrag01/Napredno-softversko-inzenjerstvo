...
# PatientSupport – Event-driven mikroservisni sistem (Apache Kafka)
...
> (U radu su dodatno pomenuti i Docker/Docker Compose za orkestraciju kontejnera.)  
...
> Napomena: U projektu je predviđeno podizanje servisa putem Docker Compose-a (jedna komanda podiže ceo sistem).  
